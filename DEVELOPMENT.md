...
```bash
git clone https://github.com/envindavsorg/cuzeacflorin.fr.git minimal-portfolio
...
npx shadcn@latest add @envindavsorg/wheel-picker
npx shadcn@latest add @envindavsorg/use-controllable-state
```
