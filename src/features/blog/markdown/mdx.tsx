...
import { ColorGenerator } from '@/features/blog/elements/ColorGenerator';
import { ComponentPreview } from '@/features/blog/elements/ComponentPreview';
...
const JSONIcon = lazy(() =>
	import('../../../elements/icons/content/JSON').then((m) => ({
		default: m.JSONIcon,
	})),
);
...
const ShadcnIcon = lazy(() =>
	import('../../../elements/icons/content/Shadcn').then((m) => ({
