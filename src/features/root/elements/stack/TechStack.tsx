...
const stackIcons = techStack.map(({ icon: Icon, title }: Stack, index) => (
	...
	<Panel id="stack">
		...
		<PanelContent className="screen-line-after">
			<Prose className="text-muted-foreground">
				...
				moderne. Au quotidien, je développe avec{' '}
				...
				pour le styling et{' '}
				<span className="font-medium text-foreground">Motion</span> pour
				les animations. Côté back-end, je travaille avec{' '}
				<span className="font-medium text-foreground">Node.js</span> et
				des frameworks comme{' '}
				<span className="font-medium text-foreground">Express</span> ou{' '}
				<span className="font-medium text-foreground">Fastify</span>,
				connectés à{' '}
				<span className="font-medium text-foreground">MongoDB</span> ou{' '}
				<span className="font-medium text-foreground">PostgreSQL</span>.
				Je maîtrise l'ensemble de la chaîne de développement, de la
				conception sur{' '}
