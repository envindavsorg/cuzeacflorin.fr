...
const DIALOG_CONTENT_CLASSES = cn(
	'sm:top-auto sm:right-0 sm:bottom-0 sm:left-auto sm:m-6',
	'sm:max-w-[375px] sm:translate-x-0 sm:translate-y-0',
	'data-[state=open]:!zoom-in-100 data-[state=open]:slide-in-from-bottom-20',
