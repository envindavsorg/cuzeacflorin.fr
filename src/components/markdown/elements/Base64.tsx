				...
				<div className="flex w-full flex-col gap-y-6 overflow-hidden">
					<div className="flex flex-col gap-y-3">
						<div className="flex items-center justify-between">
							<h3 className="mt-0 font-semibold text-base">Texte à encoder</h3>
							{encodeInputText && (
								<Button
					...
					<div className="flex flex-col gap-y-3">
						<div className="flex items-center justify-between">
							<h3 className="mt-0 font-semibold text-base">Base64</h3>
							{encodeOutputText && (
								<Button
		...
		},
		{
			...
			content: (
				<div className="flex w-full flex-col gap-y-6 overflow-hidden">
					...
					<div className="flex flex-col gap-y-3">
						<div className="flex items-center justify-between">
							<h3 className="mt-0 font-semibold text-base">Texte décodé</h3>
							{decodeOutputText && (
								<Button
