---
title: Mon portfolio - la création
description: L'histoire de la création de mon portfolio personnel avec Next.js 15, TypeScript, Tailwind CSS v4, et bien plus.
date: 2025-08-28
...
- **TimeClockWidget** : Horloge animée avec séparateur clignotant
...
Exemple du widget **TimeClockWidget** avec animation fluide :
