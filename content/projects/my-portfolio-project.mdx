...
description: L'histoire complète de la création de mon portfolio moderne : de Next.js 15 avec App Router aux widgets animés avec Zustand, en passant par l'intégration de Mapbox GL, les animations Motion, et un système de grille responsive multi-layout. Découvrez comment j'ai créé une expérience interactive avec horloge temps réel, intégrations API GitHub/LinkedIn, et un scoring Lighthouse perfect 100/100.
date: 2025-08-28
links: [{"name": "Voir le site","url": "https://cuzeacflorin.fr/","type": "demo"}, {"name": "Voir sur GitHub", "url": "https://github.com/envindavsorg/bento","type": "github"}]
---
...
- **PortfolioCreation** : Showcase du processus de création
...
- **Optimisation** : SVG minifiés, pas d'icon font, loading lazy
